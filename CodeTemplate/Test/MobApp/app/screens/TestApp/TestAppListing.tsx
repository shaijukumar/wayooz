...
const TestAppListing: React.FC<myProps> = ({ navigation }) => {

    const rootStore = useContext(RootStoreContext);
    const { loadingInitial, itemList, getList, deleteItem } = rootStore.testAppStore;
    ...
    return (
        ...
        <Screen style={styles.screen} loading={loadingInitial}>
            <Text style={appStyles.HeaderText} >TestApp List</Text>
            <FlatList
                data={itemList}
                ...
                renderItem={({ item }) => (
                    <TouchableOpacity
                        ...
                        onPress={() => { navigation.navigate("TestAppEdit", { itemId: item.Id }); }}>
            ...
            <RightBottomButton
                onPress={() => { navigation.navigate("TestAppEdit") }}
            />
...
export default observer(TestAppListing);
