...
namespace Persistence.Migrations
{
    ...
    [Migration("20210214055505_SitePager")]
    partial class SitePager
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PageTagSitePage", b =>
                {
                    b.Property<Guid>("SitePagesId")
                        .HasColumnType("TEXT");

                    b.Property<Guid>("TagsId")
                        .HasColumnType("TEXT");

                    b.HasKey("SitePagesId", "TagsId");
            ...
            modelBuilder.Entity("PageTagSitePage", b =>
                {
                    b.HasOne("Domain.SitePage", null)
                        .WithMany()
                        .HasForeignKey("SitePagesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Domain.PageTag", null)
                        .WithMany()
