...
namespace Persistence.Migrations
{
    ...
    [Migration("20210214110210_SitePager65")]
    partial class SitePager65
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.PageTagSitePage", b =>
                {
                    b.Property<Guid>("PageTagId")
                        .HasColumnType("TEXT");

                    b.Property<Guid>("SitePageId")
                        .HasColumnType("TEXT");

                    b.HasKey("PageTagId", "SitePageId");

                    b.HasIndex("SitePageId");

                    b.ToTable("PageTagSitePage");
                });
            ...
            modelBuilder.Entity("Domain.PageTagSitePage", b =>
                {
                    b.HasOne("Domain.PageTag", "PageTag")
                        .WithMany("SitePages")
                        .HasForeignKey("PageTagId")
